...
class Itinerary(models.Model):
    ...
    itinerary_point_from = models.ForeignKey(City, on_delete=models.CASCADE, related_name='point_from',
                                             verbose_name='Место погрузки')
    itinerary_point_to = models.ForeignKey(City, on_delete=models.CASCADE, related_name='point_to',
